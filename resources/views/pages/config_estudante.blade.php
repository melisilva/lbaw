...
<div class="container" style="width: auto;display: flex;padding: 0px;height: auto;">
    <div style="background: #f7f0f5;padding: 10px;">
        ...
        <form method="POST" action="{{route('config_user', ['id'=>$user->id])}}" style="width: 700px;margin: 0px;margin-bottom: 10px;">
            ...
            <p style="margin-bottom: 5px;">Curso<input class="form-control" type="text" name="course" id="course-input" placeholder="{{$curso}}"></p>
                <div style="margin-bottom: 10px;">
                    <p style="margin-bottom: 3px;">Ano Corrente</p><input type="range" name="year" class="form-control-range" id="year-range" default=$anoCorrente min=1 max=5 onchange="document.getElementById('year').innerHTML = this.value;">
<output id="year">{{$anoCorrente}}</output>
                </div>
